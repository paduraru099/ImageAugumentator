...
import { CheckAdminInterface, ForgotPasswordInterface, LoginInterface, RegisterInterface, ResetPasswordInterface, VerfiyAccountInterface } from "../Models/Interfaces"
...
export default class AccountService{
   ...
   static checkAdmin = (data:CheckAdminInterface) : Promise<Boolean> =>{
      return axios.post(`${AccountService.BASE_URL}/checkadmin`,data)
   }
